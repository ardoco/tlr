...
public class CPP14Parser extends CPP14ParserBase {
	...
	public static final int
		...
		BlockComment=9, LineComment=10, Directive=11, Alignas=12, Alignof=13, 
		Asm=14, Auto=15, Bool=16, Break=17, Case=18, Catch=19, Char=20, Char16=21, 
		Char32=22, Class=23, Const=24, Constexpr=25, Const_cast=26, Continue=27, 
		Decltype=28, Default=29, Delete=30, Do=31, Double=32, Dynamic_cast=33, 
		Else=34, Enum=35, Explicit=36, Export=37, Extern=38, False_=39, Final=40, 
		Float=41, For=42, Friend=43, Goto=44, If=45, Inline=46, Int=47, Long=48, 
		Mutable=49, Namespace=50, New=51, Noexcept=52, Nullptr=53, Operator=54, 
		Override=55, Private=56, Protected=57, Public=58, Register=59, Reinterpret_cast=60, 
		Return=61, Short=62, Signed=63, Sizeof=64, Static=65, Static_assert=66, 
		Static_cast=67, Struct=68, Switch=69, Template=70, This=71, Thread_local=72, 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"BlockComment", "LineComment", "Directive", "Alignas", "Alignof", "Asm", 
	...
	public final TranslationUnitContext translationUnit() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			if (((((_la - 12)) & ~0x3f) == 0 && ((1L << (_la - 12)) & 1543754443169808157L) != 0) || ((((_la - 76)) & ~0x3f) == 0 && ((1L << (_la - 76)) & 459384754220313597L) != 0)) {
				{
				setState(382);
				declarationseq();
				}
	...
	public final LambdaIntroducerContext lambdaIntroducer() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (((((_la - 71)) & ~0x3f) == 0 && ((1L << (_la - 71)) & -9223372032291373055L) != 0)) {
				{
				setState(452);
				lambdaCapture();
				}
	...
	public final LambdaDeclaratorContext lambdaDeclarator() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (((((_la - 12)) & ~0x3f) == 0 && ((1L << (_la - 12)) & 1237504995584196377L) != 0) || ((((_la - 76)) & ~0x3f) == 0 && ((1L << (_la - 76)) & 297237575406461917L) != 0)) {
				{
				setState(496);
		...
		try {
			...
			case 2:
				...
				case LeftParen:
					...
					_errHandler.sync(this);
					_la = _input.LA(1);
					if ((((_la) & ~0x3f) == 0 && ((1L << _la) & -3433570290080046850L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 864691647788180105L) != 0) || _la==Doublecolon || _la==Identifier) {
						{
						setState(519);
						expressionList();
						}
			...
			case 3:
				...
				setState(526);
				_la = _input.LA(1);
				if ( !(((((_la - 26)) & ~0x3f) == 0 && ((1L << (_la - 26)) & 2216203124865L) != 0)) ) {
				_errHandler.recoverInline(this);
				}
				else {
					if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final UnaryOperatorContext unaryOperator() throws RecognitionException {
		...
		try {
			...
			setState(628);
			_la = _input.LA(1);
			if ( !(((((_la - 93)) & ~0x3f) == 0 && ((1L << (_la - 93)) & 967L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
		...
		try {
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					setState(752);
					_la = _input.LA(1);
					if ( !(((((_la - 104)) & ~0x3f) == 0 && ((1L << (_la - 104)) & 49155L) != 0)) ) {
					_errHandler.recoverInline(this);
					}
					else {
						if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final AssignmentOperatorContext assignmentOperator() throws RecognitionException {
		...
		try {
			...
			setState(823);
			_la = _input.LA(1);
			if ( !(((((_la - 103)) & ~0x3f) == 0 && ((1L << (_la - 103)) & 8185L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final ExpressionStatementContext expressionStatement() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & -3433570290080046850L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 864691647653962377L) != 0) || _la==Doublecolon || _la==Identifier) {
				{
				setState(862);
				expression();
				}
	...
	public final CompoundStatementContext compoundStatement() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & -549440958425992962L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 936749241831783359L) != 0) || ((((_la - 129)) & ~0x3f) == 0 && ((1L << (_la - 129)) & 51L) != 0)) {
				{
				setState(868);
				statementSeq();
				}
	...
	public final StatementSeqContext statementSeq() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & -549440958425992962L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 936749241831783359L) != 0) || ((((_la - 129)) & ~0x3f) == 0 && ((1L << (_la - 129)) & 51L) != 0) );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
		...
		try {
			...
			case For:
				...
				case 1:
					...
					_errHandler.sync(this);
					_la = _input.LA(1);
					if ((((_la) & ~0x3f) == 0 && ((1L << _la) & -2856467044970155778L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 864691647655310235L) != 0) || _la==Doublecolon || _la==Identifier) {
						{
						setState(925);
						condition();
						}
	...
	public final DeclarationseqContext declarationseq() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( ((((_la - 12)) & ~0x3f) == 0 && ((1L << (_la - 12)) & 1543754443169808157L) != 0) || ((((_la - 76)) & ~0x3f) == 0 && ((1L << (_la - 76)) & 459384754220313597L) != 0) );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final SimpleDeclarationContext simpleDeclaration() throws RecognitionException {
		...
		try {
			...
			case Identifier:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if (_la==Decltype || _la==Operator || ((((_la - 87)) & ~0x3f) == 0 && ((1L << (_la - 87)) & 215512868999425L) != 0)) {
					{
					setState(1010);
					initDeclaratorList();
					}
	...
	public final StorageClassSpecifierContext storageClassSpecifier() throws RecognitionException {
		...
		try {
			...
			setState(1052);
			_la = _input.LA(1);
			if ( !(((((_la - 38)) & ~0x3f) == 0 && ((1L << (_la - 38)) & 17316186113L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final FunctionSpecifierContext functionSpecifier() throws RecognitionException {
		...
		try {
			...
			setState(1054);
			_la = _input.LA(1);
			if ( !(((((_la - 36)) & ~0x3f) == 0 && ((1L << (_la - 36)) & 70368744178689L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final AttributeArgumentClauseContext attributeArgumentClause() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & -2L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & -352321537L) != 0) || ((((_la - 128)) & ~0x3f) == 0 && ((1L << (_la - 128)) & 262143L) != 0)) {
				{
				setState(1330);
				balancedTokenSeq();
				}
	...
	public final BalancedTokenSeqContext balancedTokenSeq() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & -2L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & -352321537L) != 0) || ((((_la - 128)) & ~0x3f) == 0 && ((1L << (_la - 128)) & 262143L) != 0) );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
			...
			case Newline:
				...
				do {
					...
					case 1:
						...
						setState(1352);
						_la = _input.LA(1);
						if ( _la <= 0 || (((((_la - 87)) & ~0x3f) == 0 && ((1L << (_la - 87)) & 63L) != 0)) ) {
						_errHandler.recoverInline(this);
						}
						else {
							if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final InitDeclaratorContext initDeclarator() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (((((_la - 87)) & ~0x3f) == 0 && ((1L << (_la - 87)) & 65553L) != 0)) {
				{
				setState(1368);
				initializer();
				}
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case LeftBracket:
						...
						_errHandler.sync(this);
						_la = _input.LA(1);
						if ((((_la) & ~0x3f) == 0 && ((1L << _la) & -3433570290080046850L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 864691647653961865L) != 0) || _la==Doublecolon || _la==Identifier) {
							{
							setState(1403);
							constantExpression();
							}
	...
	public final AbstractPackDeclaratorContext abstractPackDeclarator() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==Decltype || ((((_la - 95)) & ~0x3f) == 0 && ((1L << (_la - 95)) & 566969237521L) != 0)) {
				{
				{
				setState(1514);
				pointerOperator();
	...
	public final ClassSpecifierContext classSpecifier() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (((((_la - 12)) & ~0x3f) == 0 && ((1L << (_la - 12)) & 1543877313594212121L) != 0) || ((((_la - 76)) & ~0x3f) == 0 && ((1L << (_la - 76)) & 463888353847684093L) != 0)) {
				{
				setState(1633);
				memberSpecification();
				}
	...
	public final MemberSpecificationContext memberSpecification() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( ((((_la - 12)) & ~0x3f) == 0 && ((1L << (_la - 12)) & 1543877313594212121L) != 0) || ((((_la - 76)) & ~0x3f) == 0 && ((1L << (_la - 76)) & 463888353847684093L) != 0) );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final MemberdeclarationContext memberdeclaration() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 18014398777921536L) != 0) || ((((_la - 87)) & ~0x3f) == 0 && ((1L << (_la - 87)) & 217711892254981L) != 0)) {
					{
					setState(1686);
	...
	public final SimpleTemplateIdContext simpleTemplateId() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & -3433570255695142658L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 864691647655043225L) != 0) || _la==Doublecolon || _la==Identifier) {
				{
				setState(1877);
	...
	public final DynamicExceptionSpecificationContext dynamicExceptionSpecification() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (((((_la - 15)) & ~0x3f) == 0 && ((1L << (_la - 15)) & -9213942612181769245L) != 0) || ((((_la - 79)) & ~0x3f) == 0 && ((1L << (_la - 79)) & 37154696925806707L) != 0)) {
				{
				setState(1979);
				typeIdList();
				}
