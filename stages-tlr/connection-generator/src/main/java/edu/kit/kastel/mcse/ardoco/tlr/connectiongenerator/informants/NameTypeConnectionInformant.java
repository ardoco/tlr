...
public class NameTypeConnectionInformant extends Informant {
    ...
    private TextStateStrategies strategy = TextStateStrategies.DEFAULT;
    ...
    private void exec(TextState textState, TextStateStrategy tss, ModelStates modelStates, RecommendationStates recommendationStates, Word word) {
        for (var model : modelStates.modelIds()) {
            ...
            this.checkForNameAfterType(textState, tss, word, modelState, recommendationState);
            this.checkForNameBeforeType(textState, tss, word, modelState, recommendationState);
            this.checkForNortBeforeType(textState, tss, word, modelState, recommendationState);
            this.checkForNortAfterType(textState, tss, word, modelState, recommendationState);
        }
    }
     ...
     */
    private void checkForNameBeforeType(TextState textExtractionState, TextStateStrategy tss, Word word, LegacyModelExtractionState modelState,
     ...
     */
    private void checkForNameAfterType(TextState textExtractionState, TextStateStrategy tss, Word word, LegacyModelExtractionState modelState,
            RecommendationState recommendationState) {
        if (textExtractionState == null || word == null) {
            return;
        }
     ...
     */
    private void checkForNortBeforeType(TextState textExtractionState, TextStateStrategy tss, Word word, LegacyModelExtractionState modelState,
            RecommendationState recommendationState) {
        if (textExtractionState == null || word == null) {
            return;
        }
     ...
     */
    private void checkForNortAfterType(TextState textExtractionState, TextStateStrategy tss, Word word, LegacyModelExtractionState modelState,
            RecommendationState recommendationState) {
        if (textExtractionState == null || word == null) {
            return;
        }
