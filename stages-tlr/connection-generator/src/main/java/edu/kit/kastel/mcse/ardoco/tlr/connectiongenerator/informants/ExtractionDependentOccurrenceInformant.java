...
public class ExtractionDependentOccurrenceInformant extends Informant {
    ...
    private void exec(TextState textState, TextStateStrategy tss, ModelStates modelStates, Word word) {
        for (var model : modelStates.modelIds()) {
            ...
            this.searchForName(modelState, textState, tss, word);
            this.searchForType(modelState, textState, tss, word);
        }
    }
     ...
     */
    private void searchForName(LegacyModelExtractionState modelState, TextState textState, TextStateStrategy tss, Word word) {
     ...
     */
    private void searchForType(LegacyModelExtractionState modelState, TextState textState, TextStateStrategy tss, Word word) {
