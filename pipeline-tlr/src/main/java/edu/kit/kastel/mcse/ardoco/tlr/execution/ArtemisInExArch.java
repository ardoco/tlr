...
/**
 * ArtemisInExArch integrates ArTEMiS into ExArch. ExArch first uses an LLM to synthesize a Simple Architecture Model (SAM) from the SAD (and optionally code).
...
public class ArtemisInExArch extends ArDoCoRunner {
    ...
    private void definePipeline(File inputText, CodeConfiguration codeConfiguration, ImmutableSortedMap<String, String> additionalConfigs,
        ...
        LlmArchitectureProviderAgent llmArchitectureProviderAgent = new LlmArchitectureProviderAgent(dataRepository, llmForExArch,
